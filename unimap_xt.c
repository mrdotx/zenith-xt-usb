...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    BOOT,NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  FONT,NO,  NO,       NO,  NO,  NO,      PWR, NO,  AUTO,BRTD,
    GUBS,NO,  WTHR,NO,  KEYB,TCOL,NO,  NO,  NO,  NO,  NO,  NO,  NO,       BSLS,     NO,  NO,  NO,      BTN2,MS_U,WH_U,BRTI,
    BTLD,NO,  NO,  NO,  NO,  NO,  SSH, NO,  NO,  NO,  WH_L,WH_R,     NO,  NO,                          MS_L,BTN3,MS_R,NO,
    TRNS,NO,  NO,  NO,  COV, VTOY,NEXT,NEOF,NO,  ACL0,ACL1,ACL2,     NO,  TRNS,          NO,           BTN1,MS_D,WH_D,NO,
